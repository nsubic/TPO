(function() {
  /* global angular */
  kartotecniListPro.$inject = ['$scope', 'estudentPodatki','$route', '$location','$routeParams'];
  function kartotecniListPro($scope, estudentPodatki,$route, $location,$routeParams) {
    var vm = this;
  ...
  angular
    .module('estudent')
    .controller('kartotecniListPro', kartotecniListPro);
