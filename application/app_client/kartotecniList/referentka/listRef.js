(function() {
  /* global angular */
  kartotecniListRef.$inject = ['$scope', 'estudentPodatki','$route', '$location','$routeParams'];
  function kartotecniListRef($scope, estudentPodatki,$route, $location,$routeParams) {
    var vm = this;
    ...
    function success(odgovor) {
      ...
      estudentPodatki.podatkiIzpitovZaStudenta(vpisna).then(
        function success(odgovor) {
          ...
          console.log(vm.izpiti.predmeti)
          var z =0;
          for(var i = 0; i<vm.pred.predmeti.length; i++){
  ...
  angular
    .module('estudent')
    .controller('kartotecniListRef', kartotecniListRef);
